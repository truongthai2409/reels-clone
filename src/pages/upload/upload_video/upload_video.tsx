...
// const initialValues: UploadVideoValues = {
//   file: null,
//   categories: [],
//   acceptTerms: false,
// };
...
//   const validate = useCallback(async (values: UploadVideoValues) => {
...
//           <h1 className="text-2xl font-semibold">Upload Video with Preview</h1>
...
//         {banner && (
//           <BannerError type={banner.type} msg={banner.msg} />
//         )}

//         <Formik<UploadVideoValues>
...
//               setBanner({
//                 type: "success",
//                 msg: `Video uploaded successfully! File ID: ${uploadResult.id}`
//               });
...
//                     {values.file ? `Selected: ${values.file.name}` : "MP4/AVI/MOV, ≤ 100MB"}
//                   </p>
//                 </div>
//                 <input
//                   id="video-input"
